...
#ifndef INTERFACES__SRV__DETAIL__LIFT__FUNCTIONS_H_
#define INTERFACES__SRV__DETAIL__LIFT__FUNCTIONS_H_
...
/// Create srv/Lift message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * interfaces__srv__Lift_Request__init().
...
/// Destroy srv/Lift message.
/**
 * It calls
 * interfaces__srv__Lift_Request__fini()
...
/// Check for srv/Lift message equality.
/**
...
/// Initialize array of srv/Lift messages.
/**
...
/// Finalize array of srv/Lift messages.
/**
 * It calls
 * interfaces__srv__Lift_Request__fini()
...
/// Create array of srv/Lift messages.
/**
 * It allocates the memory for the array and calls
 * interfaces__srv__Lift_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Lift messages.
/**
 * It calls
 * interfaces__srv__Lift_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Lift message array equality.
/**
...
/// Copy an array of srv/Lift messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * interfaces__srv__Lift_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_interfaces
...
/**
 * It calls
 * interfaces__srv__Lift_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_interfaces
...
/**
 * It allocates the memory for the array and calls
 * interfaces__srv__Lift_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_interfaces
...
/**
 * It calls
 * interfaces__srv__Lift_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // INTERFACES__SRV__DETAIL__LIFT__FUNCTIONS_H_
